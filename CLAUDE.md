...
- **MIDI Implementation doc**: `docs/FP-30X_MIDI_Imple_eng01_W.md` (markdown) or `docs/FP-30X_MIDI_Imple_eng01_W.pdf` (original). When uncertain about MIDI parameters, always check these first.
- **Constitution**: `.specify/memory/constitution.md` — full 7 principles with rationale.
- **Feature spec**: `specs/001-fp30x-custom-controller/spec.md`
- **Implementation plan**: `specs/001-fp30x-custom-controller/plan.md`
- **Task breakdown**: `specs/001-fp30x-custom-controller/tasks.md`
- **Progress tracker**: `task.md` (root) — current implementation status.

## Implementation Progress

Currently in Phase 1 MVP. Tasks T001-T018 complete (setup, MIDI encoder, BLE packet, stores, TDD tests). Next up: T019-T025 (BLE connection implementation). See `task.md` for full status.
