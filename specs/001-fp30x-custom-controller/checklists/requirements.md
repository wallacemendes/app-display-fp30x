...
- Phase 3 includes speculative reverse engineering work (memory persistence via traffic analysis of official app). FR-025 uses SHOULD instead of MUST to reflect the exploratory nature.
